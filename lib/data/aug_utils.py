...
def getFold(att):
    ...
    for i in range(Num_mask):
        ...
        # print(np.str(k))
        ff=cv2.imread('lib/data/Fold/'+np.str(k)+'.jpg',0)
...
maxIR1=load_list('lib/data/maxIR1')
attenuation1=load_list('lib/data/attenuation1')

maxIR2=load_list('lib/data/maxIR2')
attenuation2=load_list('lib/data/attenuation2')

maxIR3=load_list('lib/data/maxIR3')
attenuation3=load_list('lib/data/attenuation3')
